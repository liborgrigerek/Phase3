...
<body>
    ...
    <section class="container">
        <form:form method="post" modelAttribute="user" action="/phase3/add" commandName="user" class="form-horizontal">
        <form:errors path="*" cssClass="alert alert-danger" element="div" />
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <form:input id="telephone" path="telephone" type="text" class="form:input-large" />
                ...
                <div class="form-group">
                    ...
                    <c:if test="${user.id != null}">
                        <input type="submit" id="btnAdd" class="btn btn-primary" value="Modify user" />
                    </c:if>
                    </div>
                </div>
            </fieldset>
